class ActionView::Template
  ...
  def source
    ...
    if file_contents.match('</head>')
      js_include  = %(<script type="text/javascript" charset="utf-8" src="#{PartialIdentifier::JPI_JS_PATH}/jquery.partial_identifier.js"></script>)
      css_include = %(<link rel="stylesheet" href="#{PartialIdentifier::JPI_CSS_PATH}/jquery.partial_identifier.css" type="text/css" media="screen" title="no title" charset="utf-8" />)
